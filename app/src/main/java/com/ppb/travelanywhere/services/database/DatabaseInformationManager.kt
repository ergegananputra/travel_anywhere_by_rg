...
import com.ppb.travelanywhere.services.api.FireConsole.Companion.FIELD_ID
...
import com.ppb.travelanywhere.services.model.Stations
import com.ppb.travelanywhere.services.model.TrainClasses
import com.ppb.travelanywhere.services.model.Trains
...
class DatabaseInformationManager(
    ...
    private val factory = AppDatabaseViewModelFactory((app as TravelAnywhereApps).appRepository)
